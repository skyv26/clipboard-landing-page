...
const TextDescription = ({
  ...
  <>
    <Text fontWeight={headingWeight} as={semanticTag} color="primary.900" fontSize={headingSize} letterSpacing={{ base: '-0.52px' }}>{ heading }</Text>
    ...
    { buttonRequired && (
      <Flex color="white" fontSize={{ xs: '18px', md: '20px' }} w={['full']} mt={[6]} flexDirection={['column']} gap={{ base: 3, xs: 5 }}>
