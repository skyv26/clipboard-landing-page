...
function MicrosoftIcon({ color }) {
  return (
    ...
    >
      ...
      />
      <rect fill={`${color && (color.length !== 0) ? color : '#9EABB2'}`} width="34.2" height="34.2" />
      <rect x="37.8" fill={`${color && (color.length !== 0) ? color : '#9EABB2'}`} width="34.2" height="34.2" />
      <rect y="37.8" fill={`${color && (color.length !== 0) ? color : '#9EABB2'}`} width="34.2" height="34.2" />
      <rect x="37.8" y="37.8" fill={`${color && (color.length !== 0) ? color : '#9EABB2'}`} width="34.2" height="34.2" />
    </svg>
  );
}
